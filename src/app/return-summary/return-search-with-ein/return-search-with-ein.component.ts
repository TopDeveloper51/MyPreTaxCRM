...
@Component({
  selector: 'app-return-search-with-ein',
  templateUrl: './return-search-with-ein.component.html',
  styleUrls: ['./return-search-with-ein.component.scss']
})
export class ReturnSearchWithEinComponent implements OnInit {
  ...
  constructor(private cdr: ChangeDetectorRef,
    ...
    this.columnDefs = [
      ...
      // },
      {
        ...
        filter: 'agTextColumnFilter',
        cellRenderer: params => {
          if (params && params.value && params.data.rejection) {
            if (this.findTypeOfForRejection(params.data.rejection) == true) {
              let element = '<div>';
  ...
  // this function is to get data from api via service
