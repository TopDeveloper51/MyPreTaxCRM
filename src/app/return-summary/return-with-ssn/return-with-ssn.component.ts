...
//  External import
import { OnInit, Component, Input,Output,EventEmitter, ChangeDetectorRef, ChangeDetectionStrategy } from '@angular/core';
...
@Component({
  selector: 'app-return-with-ssn',
  templateUrl: './return-with-ssn.component.html',
  styleUrls: ['./return-with-ssn.component.scss']
})
export class ReturnWithSsnComponent implements OnInit {
   ...
   * @memberOf ReturnWithSsnComponent  = moment(contact.createdDate).tz('America/New_York').format('MM/DD/YY hh:mm A');
   */
