...
@Component({
  selector: 'app-customer-card-readonly-searchrowresult',
  templateUrl: './customer-card-readonly-searchrowresult.component.html',
  styleUrls: ['./customer-card-readonly-searchrowresult.component.scss']
})
export class CustomerCardReadonlySearchrowresultComponent implements OnInit {
